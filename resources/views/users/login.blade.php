...
<body class="">
                            ...
                            <div class="card card-plain mt-8">
                                ...
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('login.submit') }}">
                                        @csrf
                                        <input type="hidden" name="role" value="admin"> <!-- Input hidden untuk menentukan role sebagai admin -->
    ...
    <script src="{{ asset('../assets/js/corporate-ui-dashboard.min.js?v=1.0.0')